...
### Available Endpoints
- `/observability/health/summary` - System health summary (last 24h)
- `/observability/trends` - Daily run/story trends
- `/observability/runs/:workflowId` - Full trace of one brief workflow run
