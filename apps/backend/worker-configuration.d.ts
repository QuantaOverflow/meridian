/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 509db3a0befce897740aa0be89d158df)
// Runtime types generated with workerd@1.20260925.1 2026-03-24 nodejs_compat
interface __BaseEnv_Env {
	...
	PROCESS_ARTICLES: Workflow<Parameters<import("./src/index").ProcessArticles['run']>[0]['payload']>;
	AUTO_BRIEF: Workflow<Parameters<import("./src/index").AutoBriefGenerationWorkflow['run']>[0]['payload']>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "SourceScraperDO";
	}
