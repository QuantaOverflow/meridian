...
plan hash ea1cf39e862404cad7a7c8205d9034cb0493025040f2d3b08c2875c757706604；results hash 047e9a4fd3575a4cac16cd8a3b8d56ed6862f614bc0fb55ec9eaffe063c69307。产物在scripts/eval/cluster-to-brief/out/atomic-evidence/confirm-dev-v0.18。与旧失败机制相同：模型可以引用正确主体/数量同时判断错误候选supported；引用接地不保证关系一致。
